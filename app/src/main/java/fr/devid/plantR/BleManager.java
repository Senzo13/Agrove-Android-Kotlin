...
import fr.devid.plantR.bluetooth.MultipleBluetoothController;
import fr.devid.plantR.bluetooth.SplitWriter;
...
import fr.devid.plantR.callback.BleScanAndConnectCallback;
...
import fr.devid.plantR.data.BleScanState;
import fr.devid.plantR.exception.BleException;
import fr.devid.plantR.exception.OtherException;
import fr.devid.plantR.manager.JsonParser;
import fr.devid.plantR.manager.JsonParserObject;
import fr.devid.plantR.scan.BleScanRuleConfig;
import fr.devid.plantR.scan.BleScanner;
import fr.devid.plantR.utils.BleLog;
...
public class BleManager {
    ...
    private static final int DEFAULT_CONNECT_OVER_TIME = 1000000;
    ...
    public void notify(BleDevice bleDevice,
        ...
        notify(bleDevice, "1180aaaa-2e27-d9b2-064c-166aeda2cf4f", "11801111-2e27-d9b2-064c-166aeda2cf4f", false, callback);
    }
    ...
    public void notifyFlowerCare(BleDevice bleDevice,
                       BleNotifyCallback callback) {
        notify(bleDevice, "00001206-0000-1000-8000-00805f9b34fb", "00001a10-0000-1000-8000-00805f9b34fb", false, callback);
    }
    /**
     * notify
     *
     ...
     * @param callback
     */
    public void writeFlowerCare(BleDevice bleDevice,
                      byte[] data,
                      BleWriteCallback callback) {
        write(bleDevice, "00001204-0000-1000-8000-00805f9b34fb", "00001a00-0000-1000-8000-00805f9b34fb", data, true, callback);
    }
    /**
     * write
     *
    ...
    public void write(BleDevice bleDevice,
                      byte[] data,
                      BleWriteCallback callback) {
        write(bleDevice, "1180aaaa-2e27-d9b2-064c-166aeda2cf4f", "11809999-2e27-d9b2-064c-166aeda2cf4f", data, true, callback);
    }
    /**
     * write
     *
     ...
     * @param callback
     */
    public void readAgrove(BleDevice bleDevice,
                     BleReadCallback callback) {
        if (callback == null) {
            throw new IllegalArgumentException("BleReadCallback can not be Null!");
        }
        ...
        if (bleBluetooth == null) {
            ...
            bleBluetooth.newBleConnector()
                    .withUUIDString("1180aaaa-2e27-d9b2-064c-166aeda2cf4f", "11801111-2e27-d9b2-064c-166aeda2cf4f")
                    .readCharacteristic(callback, "11801111-2e27-d9b2-064c-166aeda2cf4f");
        }
    }
    /**
     * read
     ...
     * @param callback
     */
    public void readFlower(BleDevice bleDevice,
                     BleReadCallback callback) {
        if (callback == null) {
            throw new IllegalArgumentException("BleReadCallback can not be Null!");
        }
        ...
        if (bleBluetooth == null) {
            ...
            bleBluetooth.newBleConnector()
                    .withUUIDString("00001204-0000-1000-8000-00805f9b34fb","00001a01-0000-1000-8000-00805f9b34fb")
                    .readCharacteristic(callback,"00001a01-0000-1000-8000-00805f9b34fb");
        }
    }
