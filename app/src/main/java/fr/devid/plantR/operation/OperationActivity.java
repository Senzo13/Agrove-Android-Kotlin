...
public class OperationActivity extends AppCompatActivity implements Observer {
    //PAGE ENTRE LE SCAN ET LE WRITE & NOTIFY QUI AFFICHE LES SERVICES DISPONIBLES(Je pense)
    ...
    protected void onDestroy() {
        super.onDestroy();
        //fr.devid.plantR.BleManager.getInstance().clearCharacterCallback(bleDevice);
    ...
    private void initData() {
      ...
      //  singleton.startNotification(getBleDevice(), getCharacteristic());
