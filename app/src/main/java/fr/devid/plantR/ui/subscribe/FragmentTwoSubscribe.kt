...
class FragmentTwoSubscribe(val gardenerTeamId : String,var keyFragment : String):  BaseFragment() {
    @Inject
        ...
        handlePlant = plantRef.addValueEventListener(object : ValueEventListener{
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                plants?.let {
                    ...
                    adapter.currentEtage = "2" //J'envoie mon numéro du fragment, et ma gardenerId
