package fr.devid.plantR.bluetooth;
...
import fr.devid.plantR.data.BleConnectStateParameter;
import fr.devid.plantR.data.BleDevice;
import fr.devid.plantR.data.BleMsg;
import fr.devid.plantR.exception.ConnectException;
import fr.devid.plantR.exception.OtherException;
import fr.devid.plantR.exception.TimeoutException;
...
public class BleBluetooth {
    ...
    public synchronized void addNotifyCallback(String uuid, BleNotifyCallback bleNotifyCallback) {
        Timber.d("JE PASSE DANS CE gentil");
    ...
    public synchronized void destroy() {
        Timber.d("JE PASSE DANS LE DESTROY");
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case BleMsg.MSG_RECONNECT: {
                    connect(bleDevice, true, bleGattCallback, connectRetryCount);
                }
                break;
