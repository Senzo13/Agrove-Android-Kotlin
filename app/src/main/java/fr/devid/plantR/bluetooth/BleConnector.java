...
import fr.devid.plantR.data.BleWriteState;
import fr.devid.plantR.exception.GattException;
                ...
                switch (msg.what) {
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_START: {
                        ...
                        if (notifyCallback != null)
                          //  notifyCallback.onNotifyFailure("pas march");
                        break;
                    }
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_DATA_CHANGE: {
                        BleNotifyCallback notifyCallback = (BleNotifyCallback) msg.obj;
                        Singleton.Companion.getInstance().setNotifyCallback((BleNotifyCallback) msg.obj);
                        Bundle bundle = msg.getData();
                    ...
                    case BleMsg.MSG_CHA_READ_RESULT: {
                        ...
                        if (readCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                ...
                                Log.i("Ble connector", "Ma value chopé : " + Singleton.Companion.getInstance().hexToString(HexUtil.formatHexString(value)));
                            } else {
